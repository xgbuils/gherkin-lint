...
const ConfigProvider = require('../config/config-provider');
const RulesProvider = require('../rules-provider/rules-provider');
const RulesParser = require('../rules-provider/rules-parser');
...
const linterFactory = ({format, ignore, config, rulesDirs, args}, Gherkin, {cwd}) => {
